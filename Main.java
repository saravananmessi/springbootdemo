...
public class Main {
    ...
    public static final String TOKEN = "1217258476:AAH8IAYb50LC2JHsnix-7v7FNjMECK1xd0k";
    public static final String PATH = "sendmessage";


    /// Fields of Send Message
    public static final String CHATID_FIELD = "979818293";
    private static Integer chatId = 979818293; ///< Unique identifier for the message recepient — User or GroupChat id
    public static final String TEXT_FIELD = "text";
    private static String text = "Hiiiii"; ///< Text of the message to be sent
