...
public class ProjectMain_Ramesh {
...
if (listprs.getPrjCompName().trim().equalsIgnoreCase(name) && listprs.getPrjId().trim().equalsIgnoreCase(id)) {
...
level2.put(row.getCell(12) != null ? row.getCell(12).toString() : null, tag);
test.setListoftags(listChilds);
...
listChilds.add(childs);
Tags test = tags.get(tags.indexOf(tag));
level3.put(row.getCell(13) != null ? row.getCell(13).toString() : null, tag);
Tags test2 = test.getListoftags().get(tags.indexOf(tag));
test2.setListoftags(listChilds);
}
...
listChilds.add(childs);
Tags test = tags.get(tags.indexOf(tag));
level4.put(row.getCell(16) != null ? row.getCell(16).toString() : null, tag);
Tags test2 = test.getListoftags().get(tags.indexOf(tag));
Tags test3 = test2.getListoftags().get(tags.indexOf(tag));
test3.setListoftags(listChilds);
}
if (level5.containsKey(row.getCell(17) != null ? row.getCell(17).toString() : null)) {

} else {
List<Tags> listChilds = new ArrayList<Tags>();
Tags childs = new Tags();
childs.setName((row.getCell(17) != null ? row.getCell(17).toString() : null));
childs.setLevel(5);
childs.setTaxonomy(TAXONOMY);
listChilds.add(childs);
level5.put(row.getCell(17) != null ? row.getCell(17).toString() : null, tag);
Tags test = tags.get(tags.indexOf(tag));
Tags test2 = test.getListoftags().get(tags.indexOf(tag));
Tags test3 = test2.getListoftags().get(tags.indexOf(tag));
Tags test4 = test3.getListoftags().get(tags.indexOf(tag));
test4.setListoftags(listChilds);
}
}
return tags;
}
